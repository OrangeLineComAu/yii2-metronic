...
(function($, window, document, undefined) {
    ...
    Timepicker.prototype = {
        ...
        getTemplate: function() {
            ...
            (this.showSeconds ?
            '<td class="separator">&nbsp;</td>'+
            '<td><a href="#" data-action="decrementSecond"><i class="fa fa-chevron-downn"></i></a></td>'
                : '') +
            (this.showMeridian ?
            '<td class="separator">&nbsp;</td>'+
        ...
        showWidget: function() {
            ...
            $(document).on('mousedown.timepicker, touchend.timepicker', function (e) {
                //alert("on mousedown.timepicker, touchend.timepicker  "+e.target);
        ...
        toggleMeridian: function() {
            this.meridian = this.meridian === '当日' ? '次日' : '当日';
        },
